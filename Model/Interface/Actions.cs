...
namespace Poker.Interface
{
    public class Action : IEquatable<Action>
    {
        ...
        public override string ToString()
        {
            ...
            switch (type)
            {
                case ActionTypes.PostSmallBlind:
                    result.Append("posts small blind [$" + amount + "]");
                    break;
                case ActionTypes.PostBigBlind:
                    result.Append("posts big blind [$" + amount + "]");
                    break;
                ...
                case ActionTypes.Call:
                    result.Append("calls [$" + amount + "]");
                    break;
                case ActionTypes.Bet:
                    result.Append("bets [$" + amount + "]");
                    break;
                case ActionTypes.Raise:
                    result.Append("raises [$" + amount + "]");
                    break;
            }
